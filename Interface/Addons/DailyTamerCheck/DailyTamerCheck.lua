...
-- Garrison --
     ...
     -- Draenor --
	  ...
	  [37201] = {GetMapNameByID(949),{9724,2},25,pfun..pfma..pfme,{[949] = {51,71},[962] = {50,36}},949,tx_wod_bagicon}, -- cymre
	  [37205] = {GetMapNameByID(941),{9724,3},25,pfbe..pfbe..pfbe,{[941] = {68.6,64.7},[962] = {39.2,36.7}},941,tx_wod_bagicon}, -- gargra
	  [37208] = {GetMapNameByID(946),{9724,4},25,pffl..pffl..pffl,{[946] = {49.1,80.4},[962] = {41.1,65.7}},946,tx_wod_bagicon}, -- taralune
	  [37206] = {GetMapNameByID(950),{9724,5},25,pfhu..pfhu..pfhu,{[950] = {56.2,9.8},[962] = {27,43.8}},950,tx_wod_bagicon}, -- tarr
	  [37207] = {GetMapNameByID(948),{9724,6},25,pffl..pfme..pffl,{[948] = {46.3,45.3},[962] = {45.6,76.8}},948,tx_wod_bagicon}, -- vesharr

     -- Pandaren Spirits --
      [32434] = {{6974,5},"|T"..icon_firespirit..":12|t Fire Spirit",25,pfdr..pfel..pffl,{[810] = {57,42},[862] = {32,36},[-1] = {46,79},[809] = {16,64}},810,icon_firespirit},
      [32439] = {{6974,6},"|T"..icon_waterspirit..":12|t Water Spirit",25,pfwa..pfcr..pfel,{[858] = {61,88},[862] = {38,81},[-1] = {48,92}},858,icon_waterspirit},
      [32441] = {{6974,4},"|T"..icon_earthspirit..":12|t Earth Spirit",25,pfel..pfma..pfbe,{[809] = {65,94},[862] = {51,48},[-1] = {52,82},[811] = {67,14},[806] = {9,41}},809,icon_earthspirit},
      [32440] = {{6974,1},"|T"..icon_airspirit..":12|t Air Spirit",25,pffl..pfdr..pfel,{[806] = {29,36},[862] = {60,45},[-1] = {55,81}, [809] = {86,87}},806,icon_airspirit},
     -- Pandaria --
      [31953] = {{6974,1},"Hyuna",25,pffl..pfbe..pfwa,{[806] = {48,54},[862] = {69,54},[-1] = {58,84}},806,tx_bagicon},
      [31955] = {{6974,2},"Nishi",25,pfel..pfel..pfbe,{[807] = {46,44},[862] = {51,65},[-1] = {52,87}},807,tx_bagicon},
      [31954] = {{6974,3},"Mo'ruk",25,pfbe..pffl..pfwa,{[857] = {62,45},[862] = {56,79},[-1] = {54,92}},857,tx_bagicon},
      [31956] = {{6974,4},"Yon",25,pffl..pfcr..pfbe,{[809] = {36,74},[862] = {40,40},[-1] = {49,79}},809,tx_bagicon},
      [31991] = {{6974,5},"Zusshi",25,pfel..pfcr..pfwa,{[810] = {36,52},[862] = {24,40},[-1] = {44,80}},810,tx_bagicon},
      [31957] = {{6974,6},"Shu",25,pfwa..pfel..pfbe,{[858] = {55,38},[862] = {36,64},[-1] = {48,86}},858,tx_bagicon},
      [31958] = {{6974,7},"Aki",25,pfcr..pfdr..pfwa,{[811] = {31,74},[862] = {45,58},[858] = {83,20},[807] = {25,15},[-1] = {50,85}},811,tx_bagicon},
     -- Outlands --
      ...
      [31926] = {{44,7},"Antari",24,pfma..pfel..pfdr,{[473] = {31,42},[466] = {60,79}},473,tx_bagicon},
     -- Northrend --
      ...
      [31935] = {{45,9},"Payne",25,pfbe..pfme..pfel, {[492] = {77,20},[485] = {49,17},[-1] = {52,8}},492,tx_bagicon},
     -- Cataclysm --
      ...
      [31971] = {{4868,4},"Obalis",25,pfbe..pffl..pfcr,{[720] = {57,42},[13] = {49,92},[-1] = {19,75}},720,tx_bagicon},
     ...
     -- Kalimdor --
      ...
      [31909] = {{43,6},"Trixxy",19,pfdr..pfbe..pffl,{[281] = {66,65},[13] = {60,27},[-1] = {26,35}},281,tx_bagicon},
     ...
     -- Eastern Kingdoms --
      ...
      [31916] = {{42,22},"Lydia",19,pfel..pfun..pfun,{[32] = {40,77},[14] = {49,82},[-1] = {84,70}},32,tx_bagicon},
      [31911] = {{42,24},{6603,8},14,pfbe..pfbe..pfun,{[23] = {67,54},[14] = {57,32},[-1] = {90,36}},23,nil,"Alliance"},
     -- Timeless Isle --
      [33222] = {GetMapNameByID(951),"Little Tommy",125,pfbe,{[951] = {35,60},[862] = {88,71},[806] = {91,94},[-1] = {64,89}},951,nil},
...
local result = false
 ...
 tables[SAT] = {
              -- Draenor --
			   ...
			   [GARRISON_LOCATION_TOOLTIP] = {36483,36662},
               }
  AddWorldEventTamers()
...
local result, button
 ...
 if id == ABOUT then
   result.leftfont:SetText(AddColor(" Daily Tamer Check ",GOLD).."\n"..
										 ...
										 AddColor("In case you missed it, |cff00FF00Daily Global Check"..GREY.." plus \n"..
										          "|cff00FF00Daily Global Check_Pet Tamers"..GREY.." can replace \n"..
												  "Daily Tamer Check giving you the possibility to\n"..
												  "manage other types of dailies in the same manner\n\n",GREY)..
										AddColor("They can be found on Curse", GREY))		  
...
local function DTCworldmapupdate()
  ...
  if mapID ~= GetCurrentMapAreaID() then
   table.foreach(DailyTamerCheck_mapframe.framespool,function(k,v) v:Hide() end)
   active_buttons = 1
