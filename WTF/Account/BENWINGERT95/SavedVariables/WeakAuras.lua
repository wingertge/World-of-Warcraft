...
WeakAurasSaved = {
	["displays"] = {
		["asd"] = {
			...
			["anchorPoint"] = "CENTER",
			["yOffset"] = -39.0002288818359,
			["regionType"] = "icon",
			["xOffset"] = 34.9998779296875,
			["icon"] = true,
			["numTriggers"] = 1,
			...
			["frameStrata"] = 1,
			["width"] = 137.999984741211,
			["desaturate"] = false,
			["font"] = "Friz Quadrata TT",
			["inverse"] = false,
			["selfPoint"] = "CENTER",
			["height"] = 138.999969482422,
			["displayIcon"] = "Interface\\Icons\\monk_ability_fistsoffury",
			["load"] = {
				["role"] = {
					["multi"] = {
					},
	...
	["frame"] = {
		["xOffset"] = -847.000366210938,
		["width"] = 629.999938964844,
		["height"] = 492,
		["yOffset"] = -582.999877929688,
	},
	["tempIconCache"] = {
	},
